...
export const formatTerpusat = (ptk, listPelatihan) => {
  ...
  return {
    ...
    kepegawaian: {
      ...
      masa_kerja: `${ptk.masa_kerja_thn || 0} Tahun`,
    },
    riwayatPendidikanSertifikasi: {
      jenjang_terakhir: ptk.riwayat_pendidikan_formal_jenjang_pendidikan,
      bidang_pendidikan: ptk.riwayat_pendidikan_formal_bidang_studi,
      sertifikasi: ptk.riwayat_sertifikasi_bidang_studi,
      tugas_tambahan_jabatan_ptk: ptk.tugas_tambahan_jabatan_ptk,
    },
  };
};
